...
import com.example.oasis.bl.AffiliationDisplay.AffiliationDisplayService;
...
//            }
    ...
    private String getKeyWord(int id){
        ...
        for (int i=0;i<documents.size();i++){
            ...
            stringBuilder.append(documents.get(i).getIEEEterm()).append(",").append(documents.get(i).getINSPECcontrolledTerm()).append(",").append(documents.get(i).getINSPECnonControlledTerm());
